...
举例来说，今天的热门下载文件是 `Inglourious.Basterds.DVDRip.XviD-iMBT.avi`，按照以前的方式，我们需要下载它的torrent文件，然后才能下载这部电影本身。但是，在新的模式下面，我们不需要下载torrent文件，我们只需要知道它的magnet URI，就可以了。只要把这个地址告诉下载软件，软件就会开始自动下载。这和emule下载非常相似，只需要一个资源定位信息，其他都不需要。
...
https://trackerslist.com ，对应GitHub 地址： https://github.com/XIU2/TrackersListCollection
