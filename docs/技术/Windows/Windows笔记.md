...
1. 查看或计算显示器的 PPI 值，可以在线计算：[在线屏幕密度 (PPI) 计算器](https://config.net.cn/tools/PixelToPpi.html)
2. 最佳缩放比例 = 显示器 PPI ÷ 96

常用缩放值

| 显示器尺寸 |      分辨率      | PPI 值 | 最佳缩放比例 | 推荐设置缩放比例 |
| :--------: | :--------------: | :---: | :----------: | :--------------: |
|    27 寸    | 3840x2160P（4K） |  163  |     1.7      |    175% 或 200%    |
|    27 寸    | 2560x1440P（2K） |  109  |     1.14     |       125%       |
|            |                  |       |              |                  |
