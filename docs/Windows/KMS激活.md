...
开源激活工具：https://massgrave.dev/，包含 下载windows 的地址。

> 确保安装的 Windows 和 Office 是 VL 版。

## Windows 激活

KMS服务器参考：<https://www.kms.pub/>
...
如何清除KMS激活信息，参考：https://kms.library.hk/archives/31.html

## Windows GVLK密钥对照表（KMS激活专用）

以下key来源于微软官网：<https://learn.microsoft.com/zh-cn/windows-server/get-started/kms-client-activation-keys>
