...
参考：[pip官方文档](https://pip.pypa.io/en/stable/installation/)
...
# 以后升级 uv 也需要指定python3.8
python3.8 -m pip install -U -i https://pypi.tuna.tsinghua.edu.cn/simple uv

# 安装最新版的python，如果要设为系统默认python，则添加--default参数
# 以后使用 uv 管理下的虚拟环境运行所有脚本，就没必要设置为默认python了
uv python install
```

[不推荐] 如果将最新版的python设置为了系统默认python，默认仍旧无法安装包
